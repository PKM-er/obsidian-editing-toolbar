...
export const DEFAULT_SETTINGS: cMenuToolbarSettings = {
  ...
  menuCommands: [
    {
      id: 'cmenu-toolbar:editor-undo',
      name: 'undo editor',
      icon: "undo-glyph"

    },
    {
      id: 'cmenu-toolbar:editor-redo',
      name: 'redo editor',
      icon: "redo-glyph"
    },
    {
      id: "cmenu-toolbar:header2-text",
    ...
    {
      id: "cmenu-toolbar:editor:toggle-bold",
      name: "cMenuToolbar: Toggle bold",
      icon: "bold-glyph",
    },
    {
      id: "cmenu-toolbar:editor:toggle-italics",
      name: "cMenuToolbar: Toggle italics",
      icon: "italic-glyph",
    },
    {
      id: "cmenu-toolbar:editor:toggle-strikethrough",
      name: "cMenuToolbar: Toggle strikethrough",
      icon: "strikethrough-glyph",
    },
    {
      id: "cmenu-toolbar:underline",
      name: "cMenuToolbar: Toggle underline",
      icon: "underline-glyph",
    },
    {
      id: "cmenu-toolbar:superscript",
      name: "cMenuToolbar: Toggle superscript",
      icon: "superscript-glyph",
    },
    {
      id: "cmenu-toolbar:subscript",
      name: "cMenuToolbar: Toggle subscript",
      icon: "subscript-glyph",
    },
    {
      id: "cmenu-toolbar:editor:toggle-code",
      name: "cMenuToolbar: Toggle code",
      icon: "code-glyph",
    },
    {
      id: "cmenu-toolbar:codeblock",
      name: "cMenuToolbar: Toggle codeblock",
      icon: "codeblock-glyph",
    },
    {
      id: "cmenu-toolbar:editor:toggle-blockquote",
      name: "cMenuToolbar: Toggle blockquote",
      icon: "quote-glyph",
    },
    {
      id: 'cmenu-toolbar:indent-list',
      name: 'indent list',
      icon: "indent-glyph"
    },
    {
      id: 'cmenu-toolbar:undent-list',
      name: 'unindent-list',
      icon: "unindent-glyph"

    },
    {
      id: 'cmenu-toolbar:change-font-color',
    ...
    {
      id: 'cmenu-toolbar:change-background-color',
    ...
    {
      id: "cmenu-toolbar:fullscreen-focus",
      name: "Fullscreen focus mode",
      icon: "fullscreen"
    },
    {
      id: "cmenu-toolbar:workplace-fullscreen-focus",
