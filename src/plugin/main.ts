...
export default class editingToolbarPlugin extends Plugin {
  ...
  generateCommands() {
    ...
    const executeCommandWithoutBlur = async (callback: () => any) => {
      // 获取当前活动的编辑器
    ...
    this.addCommand({
      id: 'format-eraser',
      name: 'Format Eraser',
      callback: () => executeCommandWithoutBlur(()=>setFormateraser(this.app, this)),
    ...
    this.addCommand({
      ...
      callback: () => executeCommandWithoutBlur(()=>quiteFormatbrushes(this)),
    });
    this.addCommand({
      id: 'change-font-color',
      name: 'Change font color[html]',
      callback: () => executeCommandWithoutBlur(()=>setFontcolor(app, this.settings.cMenuFontColor ?? "#2DC26B")),
    ...
    this.addCommand({
      ...
      callback: () => executeCommandWithoutBlur(()=>setBackgroundcolor(app, this.settings.cMenuBackgroundColor ?? "#FA541C")),
    ...
    this.addCommand({
      ...
      callback: () => executeCommandWithoutBlur(() => {
        ...
        const editor = app.workspace.activeLeaf.view?.editor;
        // @ts-ignore - 使用扩展类型
        return editor?.toggleNumberList();
      }),
    ...
    this.addCommand({
      ...
      callback: () => executeCommandWithoutBlur(() => {
        ...
        const editor = app.workspace.activeLeaf.view?.editor;
        // @ts-ignore - 使用扩展类型
        return editor?.toggleBulletList();
      }),
      icon: "number-list-glyph"
    ...
    this.addCommand({
      ...
      callback: () => executeCommandWithoutBlur(() => {
        ...
        const editor = app.workspace.activeLeaf.view?.editor;
        // @ts-ignore - 使用扩展类型
        return editor?.toggleMarkdownFormatting("highlight");
      }),
    ...
    this.addCommand({
      ...
      callback: () => executeCommandWithoutBlur(() => {
        ...
        const editor = app.workspace.activeLeaf.view?.editor;
        // @ts-ignore - 使用扩展类型
        return editor?.toggleMarkdownFormatting("bold");
      }),
      icon: "bold-glyph"
    ...
    this.addCommand({
      ...
      callback: () => executeCommandWithoutBlur(() => {
        ...
        const editor = app.workspace.activeLeaf.view?.editor;
        // @ts-ignore - 使用扩展类型
        return editor?.toggleMarkdownFormatting("italic");
      }),
      icon: "italic-glyph"
    ...
    this.addCommand({
      id: 'editor-copy',
      name: 'Copy editor',
      callback: () => executeCommandWithoutBlur(async () => {
    ...
    this.addCommand({
      id: 'editor-paste',
      name: 'Paste editor',
      callback: async () => executeCommandWithoutBlur(async()=>{
        const editor =  app.workspace.activeLeaf.view?.editor;
        try {
    ...
    this.addCommand({
      ...
      callback: () => executeCommandWithoutBlur(()=>setHeader("")),
