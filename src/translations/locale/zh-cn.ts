export default {
  ...
  'Enable AI Rewrite': '启用 AI 改写',
  'Enable selection rewrite result panel and rewrite commands.': '启用选区改写结果面板和改写命令。',
  ...
  'Show AI Rewrite Toolbar On Selection': '选中时显示 AI 改写工具栏',
  'Show the floating AI rewrite toolbar whenever text is selected.': '选中文本时显示浮动的 AI 改写工具栏。',
  'Rewrite Minimum Selection Length': '改写最小选区长度',
  'Minimum selection length before the rewrite toolbar appears.': '达到该最小长度后才显示改写工具栏。',
  'Manual': '手动',
  'Auto': '自动',
  'PKMer AI': 'PKMer AI',
  ...
  'AI rewrite is disabled in settings.': 'AI 改写已在设置中关闭。',
