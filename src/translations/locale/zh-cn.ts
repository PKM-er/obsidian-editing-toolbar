export default {
  ...
  'Confirm delete?': '确认删除？',
  'Are you sure you want to restore all settings to default? But custom commands will be preserved.': '确定要恢复所有设置为默认值吗？【自定义命令将被保留】',
  'Successfully restored default settings! (Custom commands preserved)': '已成功恢复默认设置！【自定义命令被保留】',
  'This will reset all your custom configurations, but custom commands will be preserved': '这将重置所有自定义配置，但自定义命令将被保留',
};
