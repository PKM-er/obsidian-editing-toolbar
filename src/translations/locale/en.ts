...
'⚠️This update is not compatible with some old version command ids, please click [Repair command] to be compatible':'⚠️This update is not compatible with some old version command ids, please click [Repair command] to be compatible',
