...
'Super conversion completed: context preserved and layout optimized': 'Super conversion completed: context preserved and layout optimized',
  ...
  'Enable AI Rewrite': 'Enable AI Rewrite',
  'Enable selection rewrite result panel and rewrite commands.': 'Enable selection rewrite result panel and rewrite commands.',
  ...
  'Show AI Rewrite Toolbar On Selection': 'Show AI Rewrite Toolbar On Selection',
  'Show the floating AI rewrite toolbar whenever text is selected.': 'Show the floating AI rewrite toolbar whenever text is selected.',
  'Rewrite Minimum Selection Length': 'Rewrite Minimum Selection Length',
  'Minimum selection length before the rewrite toolbar appears.': 'Minimum selection length before the rewrite toolbar appears.',
  'Manual': 'Manual',
  'Auto': 'Auto',
  'PKMer AI': 'PKMer AI',
  ...
  'AI rewrite is disabled in settings.': 'AI rewrite is disabled in settings.',
