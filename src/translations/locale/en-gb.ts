...
'Background-color formatting brush ON!':'Background-colour formatting brush ON!\nClick the mouse middle or right key to close the formatting-brush',
...
'Get inspired by what others have created or showcase your own customizations.': 'Get inspired by what others have created or showcase your own customisations.',
...
'Select a preset toolbar theme, automatically setting the background color, icon color, and size for the selected style.': 'Select a preset toolbar theme, automatically setting the background colour, icon colour, and size for the selected style.',
